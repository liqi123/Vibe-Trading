"""Composite Volume Signal Engine — Top 1% long only.

Buy the top 1% of stocks ranked by composite volume factor score.
...
class SignalEngine:
    """Top 1% composite volume signal."""

    TOP_PCT = 0.01  # buy top 1%
